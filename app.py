...
@app.route('/hospital-home', methods=['GET', 'POST'])
@auto.doc()
def hospitalDBsearch():
    ...
    return render_template('hospital-home.html', data = visitors, username = hospital_username ), 200
...
def hospitalDBstatuschange():
    ...
    if request.method == "POST":
        ...
        return render_template('hospital-home.html', data=visitors ), 200
